# KiranaBandi Platform — Copilot Instructions
...
**KiranaBandi** is a generic, config-driven e-commerce platform built for a retail store in **Phoenix, Arizona, USA**. It is designed to be product-agnostic—initially for grocery, but architected to support any vertical without code changes.
...
This KiranaBandi platform is a modern, serverless e-commerce system built for scalability and low operational overhead. Key takeaways for development:
